    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                ...
                "isLoadrr": myData.isVpn,
                "startmokop": myData.uniqueNumber,
                "mockuLaunch": myData.wifiAddress,
                "isMeetedAppFor": myData.isCharging,
            ]
